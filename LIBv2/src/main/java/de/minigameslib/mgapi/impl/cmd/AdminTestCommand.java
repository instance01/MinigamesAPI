...
public class AdminTestCommand implements SubCommandHandlerInterface
{
    ...
    public enum Messages implements LocalizedMessageInterface
    {
         ...
         */
        @LocalizedMessage(defaultMessage = "Usage: " + LocalizedMessage.BLUE + "/mg2 admin test <internal-name>")
         ...
         * Arena test started
         */
        @LocalizedMessage(defaultMessage = "Arena " + LocalizedMessage.BLUE + "%1$s " + LocalizedMessage.GREEN + " test match was started. Players can be invited after starting was finished.", severity = MessageSeverityType.Success)
