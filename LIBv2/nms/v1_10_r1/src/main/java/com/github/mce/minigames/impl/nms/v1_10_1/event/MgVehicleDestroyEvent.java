...
import com.github.mce.minigames.api.arena.rules.bevents.MinigameVehicleDestroyEvent;
...
public class MgVehicleDestroyEvent extends AbstractMinigameEvent<VehicleDestroyEvent, MinigameVehicleDestroyEvent> implements MinigameVehicleDestroyEvent
{
     ...
     * @return passanger
     */
    private static ArenaPlayerInterface passenger(VehicleDestroyEvent event)
    {
     ...
     * @return passanger
     */
    private static ArenaInterface location(VehicleDestroyEvent event)
    {
        final Entity passenger = event.getVehicle().getPassenger();
