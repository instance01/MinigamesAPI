...
import com.github.mce.minigames.api.arena.rules.bevents.MinigameHangingBreakByEntityEvent;
...
public class MgHangingBreakByEntityEvent extends AbstractMinigameEvent<HangingBreakByEntityEvent, MinigameHangingBreakByEntityEvent> implements MinigameHangingBreakByEntityEvent
{
     ...
     * @return player
     */
    private static ArenaPlayerInterface player(HangingBreakByEntityEvent event)
    {
     ...
     * @return arena
     */
    private static ArenaInterface location(HangingBreakByEntityEvent event)
    {
        final Entity passenger = event.getRemover();
