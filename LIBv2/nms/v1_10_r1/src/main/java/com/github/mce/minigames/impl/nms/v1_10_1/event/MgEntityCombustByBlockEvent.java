...
import com.github.mce.minigames.api.arena.rules.bevents.MinigameEntityCombustByBlockEvent;
...
public class MgEntityCombustByBlockEvent extends AbstractMinigameEvent<EntityCombustByBlockEvent, MinigameEntityCombustByBlockEvent> implements MinigameEntityCombustByBlockEvent
{
     ...
     * @return player
     */
    private static ArenaPlayerInterface player(EntityCombustByBlockEvent event)
    {
     ...
     * @return arena
     */
    private static ArenaInterface location(EntityCombustByBlockEvent event)
    {
        final Entity passenger = event.getEntity();
