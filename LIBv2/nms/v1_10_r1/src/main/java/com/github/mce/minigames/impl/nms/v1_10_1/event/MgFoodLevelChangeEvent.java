...
import com.github.mce.minigames.api.arena.rules.bevents.MinigameFoodLevelChangeEvent;
 ...
 * @author mepeisen
 */
public class MgFoodLevelChangeEvent extends AbstractMinigameEvent<FoodLevelChangeEvent, MinigameFoodLevelChangeEvent> implements MinigameFoodLevelChangeEvent
{
     ...
     * @return player
     */
    private static ArenaPlayerInterface player(FoodLevelChangeEvent event)
    {
     ...
     * @return arena
     */
    private static ArenaInterface location(FoodLevelChangeEvent event)
    {
        final Entity passenger = event.getEntity();
