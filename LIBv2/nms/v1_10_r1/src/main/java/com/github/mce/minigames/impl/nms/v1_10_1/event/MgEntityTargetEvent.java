...
import com.github.mce.minigames.api.arena.rules.bevents.MinigameEntityTargetEvent;
...
public class MgEntityTargetEvent extends AbstractMinigameEvent<EntityTargetEvent, MinigameEntityTargetEvent> implements MinigameEntityTargetEvent
{
     ...
     * @return player
     */
    private static ArenaPlayerInterface player(EntityTargetEvent event)
    {
     ...
     * @return arena
     */
    private static ArenaInterface location(EntityTargetEvent event)
    {
        final Entity passenger = event.getTarget();
