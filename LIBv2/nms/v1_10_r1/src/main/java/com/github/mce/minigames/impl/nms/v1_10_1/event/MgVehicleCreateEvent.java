...
import com.github.mce.minigames.api.arena.rules.bevents.MinigameVehicleCreateEvent;
...
public class MgVehicleCreateEvent extends AbstractMinigameEvent<VehicleCreateEvent, MinigameVehicleCreateEvent> implements MinigameVehicleCreateEvent
{
     ...
     * @return passanger
     */
    private static ArenaPlayerInterface passenger(VehicleCreateEvent event)
    {
     ...
     * @return passanger
     */
    private static ArenaInterface location(VehicleCreateEvent event)
    {
        final Entity passenger = event.getVehicle().getPassenger();
