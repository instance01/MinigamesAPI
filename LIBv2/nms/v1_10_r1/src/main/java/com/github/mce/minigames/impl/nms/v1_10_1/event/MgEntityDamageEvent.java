...
import com.github.mce.minigames.api.arena.rules.bevents.MinigameEntityDamageEvent;
 ...
 * @author mepeisen
 */
public class MgEntityDamageEvent extends AbstractMinigameEvent<EntityDamageEvent, MinigameEntityDamageEvent> implements MinigameEntityDamageEvent
{
     ...
     * @return player
     */
    private static ArenaPlayerInterface player(EntityDamageEvent event)
    {
     ...
     * @return arena
     */
    private static ArenaInterface location(EntityDamageEvent event)
    {
        final Entity passenger = event.getEntity();
