...
import com.github.mce.minigames.api.arena.rules.bevents.MinigameEntityCombustEvent;
 ...
 * @author mepeisen
 */
public class MgEntityCombustEvent extends AbstractMinigameEvent<EntityCombustEvent, MinigameEntityCombustEvent> implements MinigameEntityCombustEvent
{
     ...
     * @return player
     */
    private static ArenaPlayerInterface player(EntityCombustEvent event)
    {
     ...
     * @return arena
     */
    private static ArenaInterface location(EntityCombustEvent event)
    {
        final Entity passenger = event.getEntity();
