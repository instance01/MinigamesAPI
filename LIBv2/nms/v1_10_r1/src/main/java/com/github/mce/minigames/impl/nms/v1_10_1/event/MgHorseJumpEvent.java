...
import com.github.mce.minigames.api.arena.rules.bevents.MinigameHorseJumpEvent;
 ...
 * @author mepeisen
 */
public class MgHorseJumpEvent extends AbstractMinigameEvent<HorseJumpEvent, MinigameHorseJumpEvent> implements MinigameHorseJumpEvent
{
     ...
     * @return player
     */
    private static ArenaPlayerInterface player(HorseJumpEvent event)
    {
     ...
     * @return arena
     */
    private static ArenaInterface location(HorseJumpEvent event)
    {
        final Entity passenger = event.getEntity().getPassenger();
