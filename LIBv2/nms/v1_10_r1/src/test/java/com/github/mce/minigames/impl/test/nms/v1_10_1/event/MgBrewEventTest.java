...
import com.github.mce.minigames.impl.nms.v1_10_1.event.MgBrewEvent;

/**
 * Test for {@link MgBrewEvent}
 * 
 * @author mepeisen
 *
 */
public class MgBrewEventTest
{
    ...
    public void testConstructor()
    {
        ...
        final Block brewer = mock(Block.class);
        when(brewer.getLocation()).thenReturn(loc);
        final BrewerInventory inv = mock(BrewerInventory.class);
        final BrewEvent evt = new BrewEvent(brewer, inv);
        final MgBrewEvent mgevt = new MgBrewEvent(evt);
