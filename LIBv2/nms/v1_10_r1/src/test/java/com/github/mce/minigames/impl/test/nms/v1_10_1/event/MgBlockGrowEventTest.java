...
import com.github.mce.minigames.impl.nms.v1_10_1.event.MgBlockGrowEvent;

/**
 * Test for {@link MgBlockGrowEvent}
 * 
 * @author mepeisen
 *
 */
public class MgBlockGrowEventTest
{
    ...
    public void testConstructor()
    {
        ...
        final BlockGrowEvent evt = new BlockGrowEvent(block, mock(BlockState.class));
        final MgBlockGrowEvent mgevt = new MgBlockGrowEvent(evt);
