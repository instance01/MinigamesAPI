...
import com.github.mce.minigames.impl.nms.v1_10_1.event.MgBlockFadeEvent;

/**
 * Test for {@link MgBlockFadeEvent}
 * 
 * @author mepeisen
 *
 */
public class MgBlockFadeEventTest
{
    ...
    public void testConstructor()
    {
        ...
        final BlockFadeEvent evt = new BlockFadeEvent(block, mock(BlockState.class));
        final MgBlockFadeEvent mgevt = new MgBlockFadeEvent(evt);
