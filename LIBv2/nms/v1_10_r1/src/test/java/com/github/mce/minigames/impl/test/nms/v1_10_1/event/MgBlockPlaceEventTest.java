...
import com.github.mce.minigames.impl.nms.v1_10_1.event.MgBlockPlaceEvent;


/**
 * Test for {@link MgBlockPlaceEvent}
 * 
 * @author mepeisen
 *
 */
public class MgBlockPlaceEventTest
{
    ...
    public void testConstructor()
    {
        ...
        final BlockPlaceEvent evt = new BlockPlaceEvent(block, mock(BlockState.class), mock(Block.class), new ItemStack(Material.BANNER), mock(Player.class), true, EquipmentSlot.CHEST);
        final MgBlockPlaceEvent mgevt = new MgBlockPlaceEvent(evt);
