...
import com.github.mce.minigames.impl.nms.v1_10_1.event.MgBlockBreakEvent;

/**
 * Test for {@link MgBlockBreakEvent}
 * 
 * @author mepeisen
 *
 */
public class MgBlockBreakEventTest
{
    ...
    public void testConstructor()
    {
        ...
        final BlockBreakEvent evt = new BlockBreakEvent(block, mock(Player.class));
        final MgBlockBreakEvent mgevt = new MgBlockBreakEvent(evt);
