...
import com.github.mce.minigames.impl.nms.v1_10_1.event.MgBlockIgniteEvent;

/**
 * Test for {@link MgBlockIgniteEvent}
 * 
 * @author mepeisen
 *
 */
public class MgBlockIgniteEventTest
{
    ...
    public void testConstructor()
    {
        ...
        final BlockIgniteEvent evt = new BlockIgniteEvent(block, IgniteCause.ENDER_CRYSTAL, mock(Block.class));
        final MgBlockIgniteEvent mgevt = new MgBlockIgniteEvent(evt);
