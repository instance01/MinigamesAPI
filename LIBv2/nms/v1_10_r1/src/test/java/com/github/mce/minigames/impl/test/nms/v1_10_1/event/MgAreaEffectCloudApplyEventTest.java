...
import com.github.mce.minigames.impl.nms.v1_10_1.event.MgAreaEffectCloudApplyEvent;

/**
 * Test for {@link MgAreaEffectCloudApplyEvent}
 * 
 * @author mepeisen
 *
 */
public class MgAreaEffectCloudApplyEventTest
{
    ...
    public void testConstructor()
    {
        ...
        when(cloud.getLocation()).thenReturn(loc);
        final List<LivingEntity> affected = new ArrayList<>();
        final AreaEffectCloudApplyEvent evt = new AreaEffectCloudApplyEvent(cloud, affected);
        final MgAreaEffectCloudApplyEvent mgevt = new MgAreaEffectCloudApplyEvent(evt);
