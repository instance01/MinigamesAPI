...
import com.github.mce.minigames.impl.nms.v1_10_1.event.MgBlockCanBuildEvent;

/**
 * Test for {@link MgBlockCanBuildEvent}
 * 
 * @author mepeisen
 *
 */
public class MgBlockCanBuildEventTest
{
    ...
    public void testConstructor()
    {
        ...
        final BlockCanBuildEvent evt = new BlockCanBuildEvent(block, 1, false);
        final MgBlockCanBuildEvent mgevt = new MgBlockCanBuildEvent(evt);
