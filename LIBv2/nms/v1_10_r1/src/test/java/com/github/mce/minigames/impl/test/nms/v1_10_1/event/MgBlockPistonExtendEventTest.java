...
import com.github.mce.minigames.impl.nms.v1_10_1.event.MgBlockPistonExtendEvent;

/**
 * Test for {@link MgBlockPistonExtendEvent}
 * 
 * @author mepeisen
 *
 */
public class MgBlockPistonExtendEventTest
{
    ...
    public void testConstructor()
    {
        ...
        final BlockPistonExtendEvent evt = new BlockPistonExtendEvent(block, new ArrayList<>(), BlockFace.DOWN);
        final MgBlockPistonExtendEvent mgevt = new MgBlockPistonExtendEvent(evt);
