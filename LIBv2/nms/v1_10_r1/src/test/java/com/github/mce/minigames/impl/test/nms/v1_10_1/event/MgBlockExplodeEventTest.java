...
import com.github.mce.minigames.impl.nms.v1_10_1.event.MgBlockExplodeEvent;

/**
 * Test for {@link MgBlockExplodeEvent}
 * 
 * @author mepeisen
 *
 */
public class MgBlockExplodeEventTest
{
    ...
    public void testConstructor()
    {
        ...
        final BlockExplodeEvent evt = new BlockExplodeEvent(block, new ArrayList<>(), 20);
        final MgBlockExplodeEvent mgevt = new MgBlockExplodeEvent(evt);
