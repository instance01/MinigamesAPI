...
/**
 * Similar to {@link java.util.function.DoubleConsumer} but is able to throw MinigameExceptions.
 * 
 * @author mepeisen
 *
 */
@FunctionalInterface
public interface MgDoubleConsumer
{
     ...
     */
    void accept(double value) throws MinigameException;
     ...
     */
    default MgDoubleConsumer andThen(MgDoubleConsumer after)
    {
