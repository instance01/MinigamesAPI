...
/**
 * Similar to {@link java.util.function.LongPredicate} but is able to throw MinigameExceptions.
 * 
 * @author mepeisen
 *
 */
@FunctionalInterface
public interface MgLongPredicate
{
     ...
     */
    boolean test(long value) throws MinigameException;
     ...
     *             if other is null
     */
    default MgLongPredicate and(MgLongPredicate other)
    {
     ...
     */
    default MgLongPredicate negate()
    {
     ...
     *             if other is null
     */
    default MgLongPredicate or(MgLongPredicate other)
    {
        Objects.requireNonNull(other);
        return (value) -> test(value) || other.test(value);
    }
