...
/**
 * Tests case for {@link MgDoublePredicate}
 * 
 * @author mepeisen
 */
public class MgDoublePredicateTest
{
    
    /**
     * Tests method {@link MgDoublePredicate#and(MgDoublePredicate)}
     * 
    ...
    {
        final MgDoublePredicate func = (l) -> l > 10;
        final MgDoublePredicate func2 = (l) -> l > 20;
    ...
    /**
     * Tests method {@link MgDoublePredicate#or(MgDoublePredicate)}
     * 
     * @throws MinigameException
     *             thrown on errors.
     */
    ...
    {
        final MgDoublePredicate func = (l) -> l > 10;
        final MgDoublePredicate func2 = (l) -> l < -10;
    ...
    /**
     * Tests method {@link MgDoublePredicate#negate()}
     * 
     * @throws MinigameException
     *             thrown on errors.
     */
