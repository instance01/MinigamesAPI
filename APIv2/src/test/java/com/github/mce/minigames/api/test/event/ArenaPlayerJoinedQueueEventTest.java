...
/**
 * test case for {@link ArenaPlayerJoinedQueueEvent}
 * 
 * @author mepeisen
 *
 */
public class ArenaPlayerJoinedQueueEventTest
{
    ...
    public void testMe()
    {
        ...
        assertEquals(evt.getHandlers(), ArenaPlayerJoinedQueueEvent.getHandlerList());
