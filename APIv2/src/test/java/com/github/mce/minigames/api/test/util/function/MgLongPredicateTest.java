...
/**
 * Tests case for {@link MgLongPredicate}
 * 
 * @author mepeisen
 */
public class MgLongPredicateTest
{
    
    /**
     * Tests method {@link MgLongPredicate#and(MgLongPredicate)}
     * 
    ...
    {
        final MgLongPredicate func = (l) -> l > 10;
        final MgLongPredicate func2 = (l) -> l > 20;
    ...
    /**
     * Tests method {@link MgLongPredicate#or(MgLongPredicate)}
     * 
     * @throws MinigameException
     *             thrown on errors.
     */
    ...
    {
        final MgLongPredicate func = (l) -> l > 10;
        final MgLongPredicate func2 = (l) -> l < -10;
    ...
    /**
     * Tests method {@link MgLongPredicate#negate()}
     * 
     * @throws MinigameException
     *             thrown on errors.
     */
