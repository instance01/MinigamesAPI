...
import de.minigameslib.mgapi.api.obj.LeaveZoneHandler;
 ...
 *
 */
public class LeaveZone extends AbstractBaseArenaObjectHandler<ZoneRuleSetType, ZoneRuleSetInterface, LeaveZoneData> implements LeaveZoneHandler
{
    ...
    @Override
    protected Class<LeaveZoneData> getDataClass()
    {
        return LeaveZoneData.class;
    }

    @Override
    protected LeaveZoneData createData()
    {
        return new LeaveZoneData();
    }
