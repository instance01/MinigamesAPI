 ...
 * @author mepeisen
 */
public class BasicMatchTime implements ArenaRuleSetInterface
{
     ...
     */
    public BasicMatchTime(ArenaRuleSetType type, ArenaInterface arena) throws McException
    {
        this.type = type;
        this.arena = arena;
    }
    ...
    // TODO implement BasicMatchTimeRule
