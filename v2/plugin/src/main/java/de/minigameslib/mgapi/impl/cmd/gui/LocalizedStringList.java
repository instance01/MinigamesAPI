...
public class LocalizedStringList extends AbstractPage<Locale>
{
    ...
    @Override
    protected ClickGuiItem map(Locale elm)
    {
        return new ClickGuiItem(ItemServiceInterface.instance().createItem(CommonItems.App_Text, ""), Messages.IconEdit, (p, s, g) -> onEdit(p, s, g, elm), elm.toString()); //$NON-NLS-1$
    }
