...
public class AdminStartCommand implements SubCommandHandlerInterface
{
    ...
    public enum Messages implements LocalizedMessageInterface
    {
         ...
         */
        @LocalizedMessage(defaultMessage = "Usage: " + LocalizedMessage.BLUE + "/mg2 admin start <internal-name>")
         ...
         * Arena started
         */
        @LocalizedMessage(defaultMessage = "Arena " + LocalizedMessage.BLUE + "%1$s " + LocalizedMessage.GREEN + " match was started. Players can join after starting was finished.", severity = MessageSeverityType.Success)
