        ...
        return Main.withFillers(new ClickGuiItem[][]{
            {
                ...
                null,
                new ClickGuiItem(ItemServiceInterface.instance().createItem(CommonItems.App_Delete, ""), Messages.IconDelete, this.onDelete), //$NON-NLS-1$
                null,
                new ClickGuiItem(ItemServiceInterface.instance().createItem(CommonItems.App_People, ""), Messages.IconEditUser, this::onUserString, this.title, this.locale), //$NON-NLS-1$
                new ClickGuiItem(ItemServiceInterface.instance().createItem(CommonItems.App_Boss, ""), Messages.IconEditAdmin, this::onAdminString, this.title, this.locale), //$NON-NLS-1$
                null,
                Main.itemCloseGui()
            },
        });
