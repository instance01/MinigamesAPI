...
import de.minigameslib.mgapi.api.obj.GenericComponentHandler;
 ...
 *
 */
public class GenericComponent extends AbstractBaseArenaObjectHandler<ComponentRuleSetType, ComponentRuleSetInterface, GenericComponentData> implements GenericComponentHandler
{
    ...
    @Override
    protected Class<GenericComponentData> getDataClass()
    {
        return GenericComponentData.class;
    }

    @Override
    protected GenericComponentData createData()
    {
        return new GenericComponentData();
    }
