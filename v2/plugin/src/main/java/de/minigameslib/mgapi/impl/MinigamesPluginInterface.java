...
public interface MinigamesPluginInterface
{
     ...
     * @return creator function
     */
    McSupplier<ArenaComponentHandler> creator(ComponentTypeId type);
     ...
     * @return creator function
     */
    McSupplier<ArenaZoneHandler> creator(ZoneTypeId type);
     ...
     * @return creator function
     */
    McSupplier<ArenaSignHandler> creator(SignTypeId type);
