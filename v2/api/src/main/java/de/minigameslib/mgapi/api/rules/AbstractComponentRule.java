 ...
 * @author mepeisen
 */
public abstract class AbstractComponentRule implements ComponentRuleSetInterface
{
     ...
     * rule set type.
     */
    protected final ComponentRuleSetType type;

    /**
     * The underlying component.
     */
    protected final ArenaComponentHandler component;
     ...
     */
    public AbstractComponentRule(ComponentRuleSetType type, ArenaComponentHandler component) throws McException
    {
        this.type = type;
        this.arena = component.getArena();
        this.component = component;
    }
    
    @Override
    public ComponentRuleSetType getType()
    {
        return this.type;
    }
