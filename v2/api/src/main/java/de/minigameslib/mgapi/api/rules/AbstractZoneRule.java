 ...
 * @author mepeisen
 */
public abstract class AbstractZoneRule implements ZoneRuleSetInterface
{
     ...
     * rule set type.
     */
    protected final ZoneRuleSetType type;

    /**
     * The underlying zone.
     */
    protected final ArenaZoneHandler zone;
     ...
     */
    public AbstractZoneRule(ZoneRuleSetType type, ArenaZoneHandler zone) throws McException
    {
        this.type = type;
        this.arena = zone.getArena();
        this.zone = zone;
    }
    ...
    protected void runInNewContext(McRunnable runnable) throws McException
    {
        McLibInterface.instance().runInNewContext(() -> {
            ...
            McLibInterface.instance().setContext(ZoneRuleSetInterface.class, this);
            runnable.run();
        });
    }
