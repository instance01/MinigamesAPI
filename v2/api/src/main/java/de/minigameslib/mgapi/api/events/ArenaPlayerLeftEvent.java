...
public class ArenaPlayerLeftEvent extends Event implements MinecraftEvent<ArenaPlayerLeftEvent, ArenaPlayerLeftEvent>
{
     ...
     * @param player
     */
    public ArenaPlayerLeftEvent(ArenaInterface arena, ArenaPlayerInterface player)
    {
        this.arena = arena;
        this.player = player;
    }
    ...
    @Override
    public ArenaPlayerLeftEvent getBukkitEvent()
    {
        return this;
    }
    ...
    @Override
    public McOutgoingStubbing<ArenaPlayerLeftEvent> when(McPredicate<ArenaPlayerLeftEvent> test) throws McException
    {
        if (test.test(this))
        {
