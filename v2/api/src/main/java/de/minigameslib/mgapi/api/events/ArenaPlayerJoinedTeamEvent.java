...
/**
 * Event fired after a player joined a team.
 * 
 * @author mepeisen
 * 
 * @see ArenaMatchInterface#join(ArenaPlayerInterface, TeamIdType)
 */
public class ArenaPlayerJoinedTeamEvent extends Event implements MinecraftEvent<ArenaPlayerJoinedTeamEvent, ArenaPlayerJoinedTeamEvent>
{
     ...
     * @param team
     */
    public ArenaPlayerJoinedTeamEvent(ArenaInterface arena, ArenaPlayerInterface player, TeamIdType team)
    {
        this.arena = arena;
        this.player = player;
        this.team = team;
    ...
    @Override
    public ArenaPlayerJoinedTeamEvent getBukkitEvent()
    {
        return this;
    }
    ...
    @Override
    public McOutgoingStubbing<ArenaPlayerJoinedTeamEvent> when(McPredicate<ArenaPlayerJoinedTeamEvent> test) throws McException
    {
        if (test.test(this))
        {
