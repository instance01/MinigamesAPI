...
public class ArenaPlayerJoinedSpectatorsEvent extends Event implements MinecraftEvent<ArenaPlayerJoinedSpectatorsEvent, ArenaPlayerJoinedSpectatorsEvent>
{
    ...
    @Override
    public ArenaPlayerJoinedSpectatorsEvent getBukkitEvent()
    {
        return this;
    }
    ...
    @Override
    public McOutgoingStubbing<ArenaPlayerJoinedSpectatorsEvent> when(McPredicate<ArenaPlayerJoinedSpectatorsEvent> test) throws McException
    {
        if (test.test(this))
        {
