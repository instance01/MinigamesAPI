...
public class ArenaPlayerJoinedEvent extends Event implements MinecraftEvent<ArenaPlayerJoinedEvent, ArenaPlayerJoinedEvent>
{
    ...
    @Override
    public ArenaPlayerJoinedEvent getBukkitEvent()
    {
        return this;
    }
    ...
    @Override
    public McOutgoingStubbing<ArenaPlayerJoinedEvent> when(McPredicate<ArenaPlayerJoinedEvent> test) throws McException
    {
        if (test.test(this))
        {
